//
//  JWCollectionViewHorizontalPageFlowLayout.swift
...
class JWCollectionViewHorizontalPageFlowLayout: UICollectionViewFlowLayout {
    ...
    override var collectionViewContentSize: CGSize {
        ...
        return CGSize(width: CGFloat(ceil(verticalInfo)) * collectionViewPageWidth, height: 0)
    }
